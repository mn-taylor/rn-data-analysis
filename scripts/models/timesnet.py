...
class TimesNetWrapper(nn.Module):
    """Pipeline-compatible wrapper for TimesNet classification.

    Accepts [B, C, T] input (channels_first, matching the dataloader),
    transposes to [B, T, C], and routes through TimesNet's classification path.
    x_mark_enc is set to all-ones (no padded positions in our data).
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # all-ones mask: no padding, every timestep is valid
